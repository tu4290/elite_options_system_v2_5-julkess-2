...
from data_models import ProcessedUnderlyingAggregatesV2_5, MarketRegimeEngineSettings
    ...
    def _resolve_metric_value(self, metric: str, selector: Optional[str], und_data: ProcessedUnderlyingAggregatesV2_5, df_strike: pd.DataFrame, df_chain: pd.DataFrame) -> Any:
        ...
        try:
            ...
            if selector == '@ATM':
                ...
                # FIXED: Use explicit column access to avoid ambiguity warnings
                if metric in df_strike.columns:
                    return df_strike.loc[target_strike, metric]
                return None
